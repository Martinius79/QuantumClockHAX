...
namespace lgfx
{
  inline namespace v1
  {
    ...
    bool Panel_RGB::init(bool use_reset)
    {
      ...
      //Serial.printf("Panel_RGB::init Panel_FrameBufferBase::init use_reset: %d\n", use_reset);
    ...
    */
    ...
    const uint8_t *Panel_GC9503_Quantum_Clock::getInitCommands(uint8_t listno) const
    {
      static constexpr const uint8_t list0[] = {
        ...
        0x7A, 2, 0x0F, 0x13,
        0x7B, 2, 0x0F, 0x13,
        0x6D, 32, 0x0C, 0x03, 0x1E, 0x02, 0x08, 0x1A, 0x19, 0x03, 0x0D, 0x0E, 0x0F, 0x10, 0x1E, 0x1E, 0x1E, 0x1E, 0x1E, 0x1E, 0x1E, 0x1E, 0x11, 0x12, 0x13, 0x14, 0x03, 0x19, 0x1A, 0x07, 0x01, 0x1E, 0x03, 0x0C,
